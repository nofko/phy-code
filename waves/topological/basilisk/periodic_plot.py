...
theo = scipy.io.loadmat('zeta/zeta_th_L25_N9.mat')
...
xs_01 = np.load("zeta/loc_len_A01.npy",allow_pickle=True)
xs_1 = np.load("zeta/loc_len_A1.npy",allow_pickle=True)
xs_4 = np.load("zeta/loc_len_A4.npy",allow_pickle=True)
...
print(xs_1)
plt.plot(f,-1/xs_01,"o",color="b")
plt.plot(f,-1/xs_1,"o",color="r")
